            ...
            <div className="container mx-auto px-6 relative z-50">
                <div className="grid md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div className="relative z-50">
                        <h4 className="font-semibold mb-5 text-xs tracking-wide text-white" style={{ position: 'relative', zIndex: 60, color: '#FFFFFF' }}>Contact</h4>
                    ...
                    {/* Social */}
                    <div className="relative z-50">
                        <h4 className="font-semibold mb-5 text-xs tracking-wide text-white" style={{ position: 'relative', zIndex: 60, color: '#FFFFFF' }}>Connect</h4>
                        <a
