...
const BookingCTA = () => {
    ...
    return (
        <section id="book" className="relative z-0 min-h-screen grid grid-cols-1">
            {/* Sticky Background Layer - Stays Fixed 'Underneath' */}
            ...
            {/* Content Layer - Scrolls Over */}
            <div className="col-start-1 row-start-1 flex items-center justify-center py-24 md:py-32">
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    >
                        ...
                        <h2 className="mb-6 drop-shadow-xl text-5xl md:text-7xl tracking-tight font-light leading-tight" style={{ color: '#FAF8F5' }}>
                            ...
                            <span className="inline-block mt-2 font-medium italic tracking-normal" style={{ color: '#FAF8F5' }}>the Care They Deserve?</span>
                        </h2>
